...
// Process each city
cities.forEach(city => {
    console.log(`Fixing all encoding issues for ${city}...`);
    ...
    if (fs.existsSync(filePath)) {
        ...
        // Replace all corrupted characters with correct ones
        ...
        console.log(`Fixed all encoding issues in ${filePath}`);
    } else {
        console.log(`File not found: ${filePath}`);
    }
});

console.log('All encoding fixes completed for all city guide pages!');

...
// Commercial dumpster rental page template
const commercialPageTemplate = (cityName, citySlug) => {
...
export default function ${functionName}() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section - Business-Focused Header */}
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-20 lg:py-32">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="${cityName} commercial dumpster rental background"
            fill
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Premier Commercial Dumpster Rental in ${cityName}, UT
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-gray-200 leading-relaxed">
              At Icon Dumpsters, we provide Commercial Dumpster Rental services designed for you – 
              businesses and business owners in ${cityName} who need reliable, professional waste management solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                Reserve Commercial Dumpster Now! →
              </Link>
              <Link 
...
// Residential dumpster rental page template
const residentialPageTemplate = (cityName, citySlug) => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-20 lg:py-32">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Premier Residential Dumpster Rental in ${cityName}, UT
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-gray-200 leading-relaxed">
              At Icon Dumpsters, we provide Residential Dumpster Rental services designed for you – 
              ${cityName} homeowners and residents who need reliable, convenient waste removal solutions for your projects.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/free-quote"
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-300 transform hover:scale-105"
              >
                Reserve Residential Dumpster Now! →
              </Link>
              <Link 
                href={\`/cities/\${citySlug}\`}
...
function createServicePages(citySlug) {
  ...
  const commercialContent = commercialPageTemplate(cityName, citySlug);
  ...
  const residentialContent = residentialPageTemplate(cityName, citySlug);

...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Riverton Dumpster Rental - Professional Services | Icon Dumpsters",
    description: "Professional dumpster rental services in Riverton, Utah. Same-day delivery, competitive pricing, and excellent customer service.",

...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "construction dumpster Sandy",
    "dumpster rental near me Sandy",
    "Sandy waste management",
    "dumpster delivery Sandy",
    "Sandy dumpster services"
  ],
  openGraph: {
    title: "Sandy Dumpster Rental - Professional Services | Icon Dumpsters",
    description: "Professional dumpster rental services in Sandy, Utah. Same-day delivery, competitive pricing, and excellent customer service.",
    url: "https://icondumpsters.com/slc-dumpster-rental-sandy-ut",
    siteName: "Icon Dumpsters",
    images: ['/images/og-image.png'],
  },
  alternates: {
    canonical: 'https://icondumpsters.com/slc-dumpster-rental-sandy-ut',
  },
  robots: {
    index: true,
    follow: true,

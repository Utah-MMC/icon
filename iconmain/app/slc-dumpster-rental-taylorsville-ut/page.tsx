...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Taylorsville Dumpster Rental - Professional Services | Icon Dumpsters",
    description: "Professional dumpster rental services in Taylorsville, Utah. Same-day delivery, competitive pricing, and excellent customer service.",

...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "West Valley City Dumpster Rental - Professional Services | Icon Dumpsters",
    description: "Professional dumpster rental services in West Valley City, Utah. Same-day delivery, competitive pricing, and excellent customer service.",

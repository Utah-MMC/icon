...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Salt Lake City Dumpster Rental - Professional Services | Icon Dumpsters",
    description: "Professional dumpster rental services in Salt Lake City, Utah. Same-day delivery, competitive pricing, and excellent customer service.",

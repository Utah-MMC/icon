...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Cottonwood Heights Dumpster Rental - Professional Services | Icon Dumpsters",
    description: "Professional dumpster rental services in Cottonwood Heights, Utah. Same-day delivery, competitive pricing, and excellent customer service.",

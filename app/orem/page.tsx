              ...
              <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                        <li>• <strong><a href="/dumpster-rental" className="text-blue-600 hover:text-blue-800 underline">Orem Central</a></strong> - Major retail and dining</li>
                        <li>• <strong><a href="/dumpster-rental" className="text-blue-600 hover:text-blue-800 underline">Orem East</a></strong> - Government and civic center</li>
                        <li>• <strong><a href="/dumpster-rental" className="text-blue-600 hover:text-blue-800 underline">Orem West</a></strong> - <a href="/dumpster-rental" className="text-gray-500 hover:text-gray-700">Residential and commercial mix</a></li>
                        <li>• <strong><a href="/dumpster-rental" className="text-blue-600 hover:text-blue-800 underline">Orem South</a></strong> - Industrial and commercial</li>
                        <li>• <strong><a href="/dumpster-rental" className="text-blue-600 hover:text-blue-800 underline">Orem North</a></strong> - Growing residential area</li>
                        <li>• <strong><a href="/dumpster-rental" className="text-blue-600 hover:text-blue-800 underline">Downtown Orem</a></strong> - Established neighborhoods</li>                    </ul>
                  </div>
                </div>

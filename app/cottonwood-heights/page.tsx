...
export const metadata: Metadata = {
  ...
  description: "Professional dumpster rental services in Cottonwood Heights, Utah. Fast delivery, competitive pricing, and reliable waste management solutions. Call (801) 918-6000 for instant quotes.",
  ...
  openGraph: {
    title: "Cottonwood Heights Dumpster Rental - Professional Dumpster Services in Cottonwood Heights, UT | (801) 918-6000",
    description: "Professional dumpster rental services in Cottonwood Heights, Utah. Fast delivery, competitive pricing, and reliable waste management solutions.",
...
export default function CottonwoodHeightsPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero 
        title="Cottonwood Heights Dumpster Rental"
        subtitle="Professional dumpster rental services in Cottonwood Heights, Utah. Fast delivery, competitive pricing, and reliable waste management solutions."
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Dumpster Rental Services in Cottonwood Heights</h2>
              <p className="text-lg text-gray-700 mb-6">
                Icon Dumpsters provides reliable dumpster rental services throughout Cottonwood Heights, Utah. Whether you're tackling a home renovation, construction project, or major cleanup, we have the right dumpster size for your needs.
              </p>
              ...
              <div className="mb-8">
                <img 
                  ...
                  alt="Professional dumpster rental services in Cottonwood Heights, Utah - Icon Dumpsters" 
              ...
              <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg">
                ...
                <a 
                  href="tel:801-944-7000" 
                  className="text-blue-600 hover:text-blue-800 font-semibold"
                >
                  Cottonwood Heights: (801) 944-7000
                </a>
              </div>
            </section>
            ...
            <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
              ...
              <div className="mb-8">
                <img 
                  ...
                  alt="Available dumpster sizes for Cottonwood Heights dumpster rental - 15, 20, and 30 yard options" 
            ...
            {/* Detailed Guide Link */}
            <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Complete Cottonwood Heights Dumpster Rental Guide</h2>
              <p className="text-lg text-gray-700 mb-6">
                Get detailed information about dumpster rental in Cottonwood Heights, including pricing, regulations, permit requirements, and more.
              </p>
              ...
              <div className="mb-6">
                <img 
                  ...
                  alt="Complete Cottonwood Heights dumpster rental guide with pricing and regulations" 
                  className="w-full h-48 object-cover rounded-lg shadow-md"
                />
              </div>
      ...
      <section className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get your Cottonwood Heights dumpster rental quote today. Fast delivery, competitive pricing, and professional service.
          </p>

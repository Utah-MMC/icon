  ...
  const followUpHtml = `
    ...
    <head>
      ...
      <style>
        ...
        .cta-button { display: inline-block; background: #4e37a8; color: #ffffff !important; padding: 12px 18px; border-radius: 8px; text-decoration: none; font-weight: 700; margin: 16px 0; }
      </style>
    </head>
    <body>
      <div class="container">
        ...
        <ol>
          <li>Call us at <a href="tel:+18019186000" style="color:#4e37a8;text-decoration:underline">(801) 918-6000</a> to confirm your rental</li>

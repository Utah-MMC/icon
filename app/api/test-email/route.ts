...
export async function POST(request: NextRequest) {
  try {
    ...
    // For security, only allow sending to jeremyuwg@gmail.com for testing
    if (body.to !== 'jeremyuwg@gmail.com') {
      return NextResponse.json(
        { error: 'Test emails can only be sent to jeremyuwg@gmail.com for security' },
        { status: 403 }
      );
    }

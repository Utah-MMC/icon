    ...
    const html = isNewsletter
      ...
      <body>
        <div class="container">
          ...
          <a href="tel:${phone}" style="display:inline-block;background:#4e37a8;color:#ffffff !important;padding:10px 16px;border-radius:6px;text-decoration:none;font-weight:600">Call Customer</a>
          <p class="small">${signature}</p>
        </div>
      </body>
      </html>
      ...
      `
        ...
        <body>
          <div class="container">
            ...
            <p>Please call us at <a href="tel:+18019186000" style="color:#4e37a8;text-decoration:underline">(801) 918-6000</a> to finalize your delivery details and secure your spot. Our team is standing by to help.</p>
            ...
            <a href="tel:+18019186000" style="display:inline-block;background:#4e37a8;color:#ffffff !important;padding:12px 18px;border-radius:8px;text-decoration:none;font-weight:700">Call (801) 918-6000</a>
            <p style="margin-top:16px;">${signature}</p>
          </div>
        </body>
        </html>

        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-green-50 border-l-4 border-green-400 p-6 my-6">
              <h4 className="text-lg font-semibold text-green-900 mb-3">✅ Delivery Advantages</h4>
            ...
            <div className="bg-blue-50 p-6 rounded-lg my-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h5 className="font-semibold text-blue-800 mb-2">Volume Capacity (15 cubic yards)</h5>
                ...
                <div>
                  <h5 className="font-semibold text-blue-800 mb-2">Weight Capacity (3 tons)</h5>
                  <ul className="text-blue-700 space-y-1 text-sm">
                    <li>• 6,000 pounds</li>

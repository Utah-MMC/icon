  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://icondumpsters.com/murray-dumpster-rental-guide-2025" />
        <link rel="canonical" href="https://icondumpsters.com/murray-dumpster-rental-guide-2025" />
      </Head>
          ...
          <nav className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-6">
                  ...
                  <Link href="/murray" className="hover:text-purple-600 transition-colors">Murray</Link>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-8">
            ...
            <div className="bg-gray-50 p-6 border-b">
              ...
              <nav className="space-y-2">
                <a href="#why-choose" className="block text-purple-600 hover:text-purple-800">Why Choose Icon Dumpsters in Murray?</a>
                <a href="#service-areas" className="block text-purple-600 hover:text-purple-800">Murray Service Areas</a>
                <a href="#dumpster-sizes" className="block text-purple-600 hover:text-purple-800">Dumpster Sizes & Pricing</a>
                <a href="#common-uses" className="block text-purple-600 hover:text-purple-800">Common Uses in Murray</a>
                <a href="#regulations" className="block text-purple-600 hover:text-purple-800">Murray Regulations & Permits</a>
          ...
          <div className="p-8">
            <div className="prose max-w-none">
                ...
                Murray residents and businesses trust Icon Dumpsters for reliable, affordable dumpster rental services. 
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="bg-orange-50 p-6 rounded-lg">
                      ...
                      <p className="text-gray-700">We recycle and dispose of waste responsibly, protecting Murray's environment.</p>
                    </div>
                  </div>
                </section>
                ...
                <section id="service-areas">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Murray Service Areas</h2>
                  <p className="text-lg text-gray-700 mb-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-8">
                    <div className="bg-white border border-gray-200 p-4 rounded-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">Murray Central</h4>
                      <p className="text-gray-600 text-sm">Downtown Murray, State Street corridor</p>
                    </div>
                    <div className="bg-white border border-gray-200 p-4 rounded-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">Murray East</h4>
                      <p className="text-gray-600 text-sm">East of State Street, near I-215</p>
                    </div>
                    <div className="bg-white border border-gray-200 p-4 rounded-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">Murray West</h4>
                      <p className="text-gray-600 text-sm">West of State Street, near I-15</p>
                    </div>
                    <div className="bg-white border border-gray-200 p-4 rounded-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">Murray North</h4>
                      <p className="text-gray-600 text-sm">North Murray, near South Salt Lake</p>
                    </div>
                    <div className="bg-white border border-gray-200 p-4 rounded-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">Murray South</h4>
                      <p className="text-gray-600 text-sm">South Murray, near Midvale</p>
                    </div>
                    <div className="bg-white border border-gray-200 p-4 rounded-lg">
                      <h4 className="font-semibold text-gray-900 mb-2">Surrounding Areas</h4>
                      <p className="text-gray-600 text-sm">Midvale, Sandy, South Salt Lake</p>
                    </div>
                  </div>
                </section>
                ...
                <section id="common-uses">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Common Uses in Murray</h2>
                  <p className="text-lg text-gray-700 mb-6">
                ...
                <section id="regulations">
                  <h2 className="text-3xl font-bold text-gray-900 mb-6">Murray Regulations & Permits</h2>
                  <p className="text-lg text-gray-700 mb-6">
                    When renting a dumpster in Murray, be aware of local regulations to ensure compliance and avoid fines.
                  </p>
                  
                  <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg mb-6">
                    <h3 className="text-xl font-semibold text-yellow-900 mb-4">⚠️ Important Regulations</h3>
                    <ul className="space-y-3 text-gray-700">
                      <li><strong>Street Placement:</strong> Permits may be required for street placement. Contact Murray City for permit information.</li>
                  ...
                  <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      <strong>Murray City Contact:</strong> (801) 264-2660
                    </p>
                  </div>
                </section>
                ...
                <section id="faq">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">How much does dumpster rental cost in Murray?</h3>
                      <p className="text-gray-700">
                        Our dumpster rental prices in Murray start at $300 for a 15-yard dumpster (3-7 days), $350 for a 20-yard dumpster, and $375 for a 30-yard dumpster. 1-day special rates start at $180. All prices include delivery, pickup, and disposal fees.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h3 className="text-lg font-semibold text-gray-900 mb-3">Do you offer same-day delivery in Murray?</h3>
                      <p className="text-gray-700">
                        Yes! We offer same-day delivery in Murray and throughout the Salt Lake Valley. Call us early in the day for same-day service availability.
                      </p>
                    </div>

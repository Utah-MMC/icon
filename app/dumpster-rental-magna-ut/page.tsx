...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `/dumpster-rental-magna-ut` },
  openGraph: {
    title: `Dumpster Rental Magna, UT | Same-Day Delivery | Icon Dumpsters`,
    ...
    url: `https://icondumpsters.com/dumpster-rental-magna-ut`,
...
export default function MagnaDumpsterRentalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <PageHero
        title={`Dumpster Rental in Magna, UT`}
        subtitle={`Fast, reliable dumpster delivery for all your Magna projects`}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative w-full h-64 rounded-lg overflow-hidden">
              <OptimizedImage src="/images/optimized/dumpsterSmallBanner5.jpg"
                alt="Magna dumpster rental service areas"
                fill

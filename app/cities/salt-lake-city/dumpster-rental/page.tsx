    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6">Dumpster Rental in Salt Lake City, UT</h1>
          <p className="text-xl mb-8">Fast, reliable dumpster delivery for all your Salt Lake City projects</p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link 
              href="https://icondumpsters.com/cities/salt-lake-city"

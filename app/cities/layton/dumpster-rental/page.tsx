    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6">Dumpster Rental in Layton, UT</h1>
          <p className="text-xl mb-8">Fast, reliable dumpster delivery for all your Layton projects</p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link 
              href="https://icondumpsters.com/cities/layton"
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link 
              href="https://icondumpsters.com/layton-dumpster-rental-guide-2025"
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors"
            >

...
export const metadata: Metadata = {
  title: 'Magna, UT | Icon Dumpsters - Local Dumpster Rental Services',
  description: 'Magna, Utah dumpster rental services. Get fast, reliable dumpster delivery for your construction, renovation, or cleanup projects.',
  keywords: ['Magna UT', 'Magna Utah', 'Magna dumpster rental', 'Magna construction', 'Magna renovation'],
  alternates: { canonical: '/cities/magna' },
};

export default function MagnaCityPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section using PageHero component */}
      <PageHero
        title={`Magna, Utah`}
        subtitle={`Your trusted partner for dumpster rental services in Magna`}
        primaryCtaText="Get Dumpster Quote"
        primaryCtaLink="/dumpster-rental-magna-ut"
        secondaryCtaText="Read Our Guide"
        secondaryCtaLink="/magna-dumpster-rental-guide-2025"
      />
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h2 className="text-3xl font-bold mb-6 text-gray-800">About Magna</h2>
            <p className="text-lg text-gray-600 mb-6">
              Magna is a vibrant city in Utah, known for its excellent community spirit and 
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Our Services in Magna</h2>
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">Get your free dumpster rental quote for your Magna project today</p>

        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <header className="mb-12 text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              Use our concrete dumpster calculator to estimate the right dumpster size and costs for concrete disposal. 
              Calculate concrete weight, volume, and rental costs for Utah projects with accurate pricing.
            </p>
          ...
          <section className="mb-16 bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg border border-gray-100">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Calculate the perfect dumpster size and cost for your concrete disposal project. Enter your project details below.
              </p>
            </div>
            <DumpsterCalculator />
          </section>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              ...
              Our concrete dumpster calculator helps you accurately estimate the dumpster size and costs needed for your concrete disposal project.
            </p>
            ...
            <ul>
              ...
              <li><strong>Disposal Fees:</strong> Concrete disposal often has different pricing than general waste</li>
            ...
            <h3>Dumpster Size Guidelines for Concrete Projects</h3>
            ...
            <div className="bg-green-50 p-6 rounded-lg my-6">
              <h4 className="text-lg font-semibold text-green-900 mb-3">Concrete Volume Calculation</h4>

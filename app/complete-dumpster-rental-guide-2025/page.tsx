...
export const metadata: Metadata = {
  title: "Complete Guide to Dumpster Rental: Everything You Need to Know in 2025 | Icon Dumpsters",
  description: "Master dumpster rental with our comprehensive 2025 guide. Learn about sizes, costs, regulations, and tips for construction and cleanup projects. Expert advice from Icon Dumpsters.",
  keywords: "dumpster rental guide, dumpster rental 2025, dumpster sizes, dumpster rental costs, construction dumpster, roll-off dumpster, dumpster rental near me, Utah dumpster rental, Icon Dumpsters",
  openGraph: {
    title: "Complete Guide to Dumpster Rental: Everything You Need to Know in 2025",
    description: "Master dumpster rental with our comprehensive 2025 guide. Learn about sizes, costs, regulations, and tips for construction and cleanup projects.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Complete Dumpster Rental Guide 2025 - Icon Dumpsters',
      },
    ],
  },
  twitter: {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                <ImageWithFallback
                  ...
                  alt="Medium dumpster ideal for larger renovation projects"
                  width={400}
                  height={200}
                  className="w-full h-32 object-cover rounded-lg mb-4"
                />

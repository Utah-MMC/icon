              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                <div className="mb-8">
                  <img 
                    ...
                    alt="Professional dumpster rental services in Layton, Utah - Icon Dumpsters" 
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Available Dumpster Sizes</h2>                
                ...
                <div className="mb-8">
                  <img 
                    ...
                    alt="Available dumpster sizes for Layton dumpster rental - 15, 20, and 30 yard options" 
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                <div className="mb-6">
                  <img 
                    ...
                    alt="Complete Layton dumpster rental guide with pricing and regulations" 
                    className="w-full h-48 object-cover rounded-lg shadow-md"
                  />
                </div>                
                {/* Hero Image */}

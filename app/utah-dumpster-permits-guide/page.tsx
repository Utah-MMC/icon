...
export const metadata: Metadata = {
  title: 'Utah Dumpster Permits Guide 2025 | Complete Permit Information',
            ...
            <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 mb-3">
                    <strong>Contact:</strong> <a href="tel:801-535-6000" className="text-blue-600 hover:text-blue-800">(801) 535-6000</a>
                  </p>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 mb-3">
                    <strong>Contact:</strong> <a href="tel:801-963-3200" className="text-blue-600 hover:text-blue-800">(801) 963-3200</a>
                  </p>
                  <p className="text-gray-700">
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 mb-3">
                    <strong>Contact:</strong> <a href="tel:801-852-6400" className="text-blue-600 hover:text-blue-800">(801) 852-6400</a>
                  </p>
                  <p className="text-gray-700">
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 mb-3">
                    <strong>Contact:</strong> <a href="tel:801-629-8200" className="text-blue-600 hover:text-blue-800">(801) 629-8200</a>
                  </p>
                  <p className="text-gray-700">
                    <strong>Process:</strong> Apply at the Community Development Department
                  </p>
                ...
                <div className="border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 mb-3">
                    <strong>Contact:</strong> <a href="tel:435-843-2120" className="text-blue-600 hover:text-blue-800">(435) 843-2120</a>
                  </p>
                  <p className="text-gray-700">
                    <strong>Process:</strong> Apply at the Building Department
                  </p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <a href="tel:801-535-6000" className="text-blue-600 hover:text-blue-800">(801) 535-6000</a>
                  </div>
                  <div>
                    <strong>West Valley City:</strong><br />
                    <a href="tel:801-963-3200" className="text-blue-600 hover:text-blue-800">(801) 963-3200</a>
                  </div>
                  <div>
                    <strong>Provo:</strong><br />
                    <a href="tel:801-852-6400" className="text-blue-600 hover:text-blue-800">(801) 852-6400</a>
                  </div>
                  <div>
                    <strong>Ogden:</strong><br />
                    <a href="tel:801-629-8200" className="text-blue-600 hover:text-blue-800">(801) 629-8200</a>
                  </div>
                </div>
              </div>

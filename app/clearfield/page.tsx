...
export const metadata: Metadata = {
  ...
  description: "Professional dumpster rental services in Clearfield, Utah. Fast delivery, competitive pricing, and reliable waste management solutions. Call (801) 918-6000 for instant quotes.",
  ...
  openGraph: {
    title: "Clearfield Dumpster Rental - Professional Dumpster Services in Clearfield, UT | (801) 918-6000",
    description: "Professional dumpster rental services in Clearfield, Utah. Fast delivery, competitive pricing, and reliable waste management solutions.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Clearfield Dumpster Rental
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Professional dumpster rental services in Clearfield, Utah. Fast delivery, competitive pricing, and reliable waste management solutions.
            </p>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Dumpster Rental Services in Clearfield</h2>
              <p className="text-lg text-gray-700 mb-6">
                Icon Dumpsters provides reliable dumpster rental services throughout Clearfield, Utah. Whether you're tackling a home renovation, construction project, or major cleanup, we have the right dumpster size for your needs.
              </p>                
                {/* Hero Image */}
                <div className="mb-8">
                  <img 
                    src="/images/IMG_0350.jpg" 
                    alt="Professional dumpster rental services in Clearfield, Utah - Icon Dumpsters" 
              ...
              <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg">
                ...
                <a 
                  href="tel:801-525-2700" 
                  className="text-blue-600 hover:text-blue-800 font-semibold"
                >
                  Clearfield: (801-525-2700)
                </a>
              </div>
            </section>
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Available Dumpster Sizes</h2>                
                ...
                <div className="mb-8">
                  <img 
                    ...
                    alt="Available dumpster sizes for Clearfield dumpster rental - 15, 20, and 30 yard options" 
            ...
            {/* Detailed Guide Link */}
            <section className="bg-white rounded-xl shadow-lg p-8 mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Complete Clearfield Dumpster Rental Guide</h2>
              <p className="text-lg text-gray-700 mb-6">
                Get detailed information about dumpster rental in Clearfield, including pricing, regulations, permit requirements, and more.
              </p>                
                {/* Guide Image */}
                <div className="mb-6">
                  <img 
                    src="/images/IMG_0336.jpg" 
                    alt="Complete Clearfield dumpster rental guide with pricing and regulations" 
                    className="w-full h-48 object-cover rounded-lg shadow-md"
                  />
                </div>                
                {/* Hero Image */}
      ...
      <section className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Get your Clearfield dumpster rental quote today. Fast delivery, competitive pricing, and professional service.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="tel:801-918-6000" 

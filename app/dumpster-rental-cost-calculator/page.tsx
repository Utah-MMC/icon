...
export const metadata: Metadata = {
  title: 'Dumpster Rental Cost Calculator Utah: Pricing Guide & Hidden Fees Breakdown | Icon Dumpsters',
  description: 'Complete dumpster rental cost calculator for Utah. Calculate total costs including rental fees, permits, weight charges, and hidden fees. Get accurate pricing for 15, 20, and 30-yard dumpsters.',
  ...
  alternates: { canonical: 'https://icondumpsters.com/dumpster-rental-cost-calculator' },
  openGraph: {
    title: 'Dumpster Rental Cost Calculator Utah: Pricing Guide & Hidden Fees Breakdown',
    description: 'Complete dumpster rental cost calculator for Utah. Calculate total costs including rental fees, permits, weight charges, and hidden fees.',
    url: 'https://icondumpsters.com/dumpster-rental-cost-calculator',
    images: [{ url: '/images/og-image.png', width: 1200, height: 630, alt: 'Utah Dumpster Rental Cost Calculator' }],
    type: 'website'
  },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-100 max-w-4xl mx-auto leading-relaxed">
              Complete cost breakdown for dumpster rentals in Utah. Calculate total expenses including rental fees, permits, weight charges, and hidden costs. Get accurate pricing estimates for your project.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <div className="flex items-center text-white/90">
                ...
                <span>Utah-Specific Pricing</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Estimate your total dumpster rental costs including all fees and charges. Get accurate pricing for your Utah project.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              ...
              <div className="space-y-6">
                {/* Dumpster Size */}
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Dumpster Size</label>
                  <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4e37a8] focus:border-transparent">
                ...
                {/* Calculate Button */}
                <button className="w-full bg-gradient-to-r from-[#4e37a8] to-purple-600 text-white py-4 rounded-lg font-bold text-lg hover:from-purple-600 hover:to-[#4e37a8] transition-all duration-300">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-4 bg-gray-50 rounded-lg px-4">
                  ...
                  <span className="text-xl font-bold text-[#4e37a8]">$605</span>
                </div>
              </div>
                    ...
                    {category.items.map((item, itemIndex) => (
                      <div key={itemIndex} className="border border-gray-200 rounded-lg p-4">
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span className="text-lg font-bold text-[#4e37a8]">{item.cost}</span>
                        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Compare total costs for different project types and dumpster sizes in Utah.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
              ...
              <div className="border-t border-gray-200 pt-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-[#4e37a8]">$525</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 transform scale-105">
              ...
              <div className="border-t border-gray-200 pt-3">
                <div className="flex justify-between items-center">
                  <span className="text-lg font-bold text-gray-900">Total Cost</span>
                  <span className="text-xl font-bold text-[#4e37a8]">$685</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
              ...
              <div className="border-t border-gray-200 pt-3">
                <div className="flex justify-between items-center">
                  <span className="text-lg font-bold text-gray-900">Total Cost</span>
                  <span className="text-xl font-bold text-[#4e37a8]">$920</span>
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Expert answers to common questions about dumpster rental costs and pricing in Utah.
            </p>
          </div>
      ...
      <section className="bg-gradient-to-r from-[#4e37a8] to-purple-600 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Icon Dumpsters provides transparent pricing with no hidden fees. Get an accurate quote for your Utah project today.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  <a href="/transparent-pricing" className="text-[#4e37a8] hover:text-purple-700 transition-colors">
                    Transparent Pricing
                  </a>
                </h3>
              </div>

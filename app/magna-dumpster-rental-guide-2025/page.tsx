...
export const metadata: Metadata = {
  ...
  description: 'Professional dumpster rental services in Magna, UT. Fast delivery, competitive pricing, and reliable waste management solutions. Call 801-918-6000 for instant quotes.',
  keywords: 'Magna dumpster rental, dumpster rental Magna UT, Magna UT dumpster, roll-off dumpster Magna, construction dumpster Magna, waste management Magna',
  openGraph: {
    title: 'Magna Dumpster Rental - Professional Dumpster Services in Magna, UT | (801-918-6000)',
    description: 'Professional dumpster rental services in Magna, UT. Fast delivery, competitive pricing, and reliable waste management solutions.',
  ...
  other: {
    'geo.region': 'US-UT',
    'geo.placename': 'Magna, UT',
    'geo.position': '40.7608;-111.8910',
    'ICBM': '40.7608, -111.8910',
  },
};

export default function MagnaDumpsterRental() {
  const cityData = {
    cityName: 'Magna',
    citySlug: 'magna',
    state: 'UT',

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Master home renovation waste disposal with our comprehensive guide. Learn proper disposal methods, recycling strategies, and cost-saving tips for your renovation project.',
    type: 'article',
    url: 'https://iconmain.com/home-renovation-waste-disposal-complete-guide',
    images: [
      {
  ...
  alternates: {
    canonical: 'https://iconmain.com/home-renovation-waste-disposal-complete-guide'
  },
  robots: 'index, follow'
}
...
export default function HomeRenovationWasteDisposalGuide() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        title="Home Renovation Waste Disposal: Complete Guide for 2025"
        subtitle="Master home renovation waste disposal with our comprehensive guide. Learn proper disposal methods, recycling strategies, and cost-saving tips."
        primaryCtaText="Get Renovation Quote"
        ...
        <div className="prose max-w-none">
          ...
          <section id="dumpster-sizing" className="mt-16">
            ...
            <div className="bg-green-50 border-l-4 border-green-400 p-6 rounded-r-lg mb-8">
              <h3 className="text-xl font-semibold text-green-900 mb-3">Size Selection Guide</h3>

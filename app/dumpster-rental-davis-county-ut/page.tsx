      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/layton-ut"
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/clearfield-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/kaysville-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/bountiful-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/centerville-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/farmington-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/clinton-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/syracuse-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/north-salt-lake-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/woods-cross-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/west-bountiful-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/sunset-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >
            ...
            <Link
              href="/dumpster-rental-davis-county-ut/south-weber-ut"
              className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow border border-gray-200"
            >

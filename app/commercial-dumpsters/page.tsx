...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/commercial-dumpsters" },
  openGraph: {
    title: "Commercial Dumpster Rental Utah | Business & Construction Waste Management",
    description: "Professional commercial dumpster rental services in Utah. Construction waste management, business dumpster solutions, and roll-off containers for commercial projects.",

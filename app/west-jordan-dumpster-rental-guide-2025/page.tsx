...
export const metadata: Metadata = {
  ...
  description: 'Professional dumpster rental services in West Jordan, UT. Fast delivery, competitive pricing, and reliable waste management solutions. Call 801-918-6000 for instant quotes.',
  keywords: 'West Jordan dumpster rental, dumpster rental West Jordan UT, West Jordan UT dumpster, roll-off dumpster West Jordan, construction dumpster West Jordan, waste management West Jordan',
  openGraph: {
    title: 'West Jordan Dumpster Rental - Professional Dumpster Services in West Jordan, UT | (801-918-6000)',
    description: 'Professional dumpster rental services in West Jordan, UT. Fast delivery, competitive pricing, and reliable waste management solutions.',
...
export default function WestJordanDumpsterRental() {
    ...
    landmarks: [
  {
    ...
    "url": "https://www.west-jordan.utah.gov/"
  },
  {
    "name": "West Jordan Park",
    "address": "Local Park Address",
    "url": "https://www.google.com/maps/search/West Jordan%20Park"
  }
],
    businessDistricts: [
  {

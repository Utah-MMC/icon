...
export const metadata: Metadata = {
  ...
  description: "Comprehensive dumpster rental services in Tooele, Utah. Residential, commercial, construction, and demolition services. Same-day delivery available. 15-30 yard roll-off dumpsters. Call (801) 918-6000.",
  keywords: "Tooele dumpster rental services, residential dumpster Tooele, commercial dumpster Tooele, construction dumpster Tooele, waste management Tooele, roll-off dumpster Tooele",
  openGraph: {
    title: "Tooele Dumpster Rental Services - Residential & Commercial | Icon Dumpsters",
...
export default function TooeleServicesPage() {
  return (
    <PageTemplate>
      <PageHero
        title="Tooele Dumpster Rental Services"
        subtitle="Comprehensive waste management solutions for residential and commercial projects in Tooele, Utah"
        primaryCtaText="Get Free Quote"
        primaryCtaLink="/tooele-dumpster-rentals#quote-form"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Professional Dumpster Rental Services in Tooele, Utah
          </h2>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
            At Icon Dumpsters, we provide comprehensive dumpster rental services throughout Tooele and surrounding areas. Our mission is to deliver hassle-free, professional waste management solutions for homeowners, contractors, and businesses alike.
          </p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="mb-6">
              <OptimizedImage src="/images/optimized/IMG_3190.jpg"
                alt="Residential dumpster rental services in Tooele, Utah"
                width={600}
                height={300}
            ...
            <p className="text-lg text-gray-700 mb-6">
              Our residential dumpster rental services in Tooele are designed to handle all your home improvement and cleanup needs. From small renovation projects to major home overhauls, we provide the right dumpster size for your specific requirements.
            </p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="mb-6">
              <OptimizedImage src="/images/optimized/commercial.jpg"
                alt="Commercial dumpster rental services in Tooele, Utah"
                width={600}
                height={300}
                className="w-full h-48 object-cover rounded-lg"
              />
            ...
            <p className="text-lg text-gray-700 mb-6">
              Our commercial dumpster rental services in Tooele support businesses of all sizes with reliable waste management solutions. We understand the unique needs of commercial projects and provide flexible rental terms to accommodate your business operations.
            </p>
            <ul className="space-y-3 text-lg text-gray-700 mb-6">
        ...
        <section className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Available Dumpster Sizes for Tooele Projects</h2>
          <p className="text-lg text-gray-700 mb-8 text-center max-w-4xl mx-auto">
            Choose the perfect dumpster size for your Tooele project. All rentals include delivery, pickup, and landfill fees. Weight is billed at $55/ton after pickup.
          </p>
          
          <div className="mb-8">
            <OptimizedImage src="/images/optimized/20-yard-roll-off-dumpster-rental-graphic-labeled.jpg"
              alt="Dumpster size comparison for Tooele projects"
              width={800}
              height={300}
        ...
        {/* Service Process */}
        <section className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Our Tooele Service Process</h2>
          <p className="text-lg text-gray-700 mb-8 text-center max-w-4xl mx-auto">
            Our streamlined process makes dumpster rental in Tooele simple and stress-free. From initial consultation to final pickup, we handle every detail professionally.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="bg-blue-50 p-6 rounded-lg text-center">
            ...
            <p className="text-gray-700 mb-4">Fast, reliable delivery throughout Tooele and surrounding areas. Order by 3 PM for next-day delivery.</p>
          ...
          <div className="bg-green-50 p-6 rounded-lg text-center">
            ...
            <p className="text-gray-700 mb-4">Transparent pricing with no hidden fees. Best rates in Tooele and the surrounding area.</p>
            <ul className="text-sm text-gray-600 space-y-1">
        ...
        {/* Local Information */}
        <section className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Serving Tooele and Surrounding Areas</h2>
          <p className="text-lg text-gray-700 mb-8 text-center max-w-4xl mx-auto">
            Icon Dumpsters proudly serves Tooele, Utah, and the surrounding communities. We understand the local area and can help you navigate any permit requirements or local regulations.
          </p>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">🏛️ Tooele Permit Information</h3>
              <p className="text-gray-700 mb-4">
                Tooele may require permits for dumpster placement on public streets or certain locations. Contact Tooele City to check specific requirements for your address.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4">
                We provide dumpster rental services throughout Tooele and surrounding areas.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Tooele City limits</li>
        ...
        {/* FAQ Section */}
        <section className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Frequently Asked Questions - Tooele Dumpster Rental</h2>
          
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Do I need a permit for dumpster rental in Tooele?</h3>
              <p className="text-gray-700">
                Permit requirements vary by location in Tooele. Contact Tooele City to check specific requirements for your address. We can help guide you through the permit process and ensure compliance with local regulations.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700">
                Yes, we offer same-day delivery throughout Tooele when available. Call us early in the day to check availability and schedule same-day service for urgent projects.
              </p>
            </div>
        ...
        {/* CTA Section */}
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Get Started with Your Tooele Project?</h2>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Get your Tooele dumpster rental quote today. Fast delivery, competitive pricing, and professional service you can trust.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              href="/tooele-dumpster-rentals#quote-form"

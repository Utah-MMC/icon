...
export const metadata: Metadata = {
  title: 'Utah Waste Management Regulations: Complete Guide to Dumpster Rental Laws | Icon Dumpsters',
  description: 'Complete guide to Utah waste management regulations for dumpster rentals. Learn about permits, prohibited materials, disposal requirements, and compliance with Utah DEQ regulations.',
  ...
  openGraph: {
    title: 'Utah Waste Management Regulations: Complete Guide to Dumpster Rental Laws',
    ...
    images: [{ url: '/images/og-image.png', width: 1200, height: 630, alt: 'Utah Waste Management Regulations Guide' }],
    type: 'website'
  },
              ...
              <div key={index} className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex flex-col space-y-2">
                    <a href={`tel:${agency.contact}`} className="text-[#4e37a8] hover:underline font-semibold">
                      {agency.contact}
                    </a>
                    <a href={`https://${agency.website}`} target="_blank" rel="noopener noreferrer" className="text-[#4e37a8] hover:underline">
                      {agency.website}
                    </a>
                  </div>
                </div>

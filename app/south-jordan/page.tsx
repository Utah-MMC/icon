    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-lg text-gray-600 mb-8">
          Professional dumpster rental services in South Jordan, Utah. Get same-day delivery for 15-30 yard roll-off dumpsters.
        </p>
        
        <div className="bg-gray-50 p-8 rounded-lg mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Why Choose Icon Dumpsters in South Jordan?</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-600">
            <li>Same-day delivery to South Jordan and surrounding areas</li>
            <li>Competitive pricing with no hidden fees</li>
            <li>Flexible rental periods (1-30 days)</li>
            <li>Professional customer service</li>
            <li>Local knowledge of South Jordan regulations</li>
            <li>Multiple dumpster sizes available</li>
          </ul>
        </div>

        <div className="bg-blue-50 p-8 rounded-lg mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">South Jordan Service Areas</h2>
          <p className="text-gray-600 mb-4">We serve all of South Jordan and surrounding communities:</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2">South Jordan Areas:</h3>
              <ul className="space-y-1 text-gray-600">
                <li>• Downtown South Jordan</li>
                <li>• South Jordan Heights</li>
                <li>• Daybreak</li>

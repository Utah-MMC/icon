...
export const metadata: Metadata = {
  ...
  description: 'Expert dumpster size guide for Utah projects. Compare 15, 20, and 30-yard dumpsters with dimensions, capacity, and project-specific recommendations. Get the right size for your Utah project.',
  ...
  alternates: { canonical: 'https://icondumpsters.com/dumpster-size-guide-utah' },
  openGraph: {
    title: 'Dumpster Size Guide Utah: Complete Sizing Chart & Project Recommendations',
    description: 'Expert dumpster size guide for Utah projects. Compare 15, 20, and 30-yard dumpsters with dimensions, capacity, and project-specific recommendations.',
    url: 'https://icondumpsters.com/dumpster-size-guide-utah',
    images: [{ url: '/images/og-image.png', width: 1200, height: 630, alt: 'Utah Dumpster Size Guide' }],
    type: 'website'
  },
...
const sizeGuideFAQs = [
  {
    ...
    answer: "In Utah, dumpster dimensions are standardized: 15-yard dumpsters measure 16' x 7' x 4' (L x W x H), 20-yard dumpsters are 16' x 7' x 6', and 30-yard dumpsters are 22' x 7' x 6'. These dimensions are consistent across all Utah dumpster rental companies and are designed to fit standard delivery trucks and residential driveways."
  },
  {
  ...
  },
  {
    ...
    answer: "30-yard dumpsters require 22 feet of length and 7 feet of width, plus 60 feet of overhead clearance for delivery. Most Utah driveways can accommodate them, but measure first. The delivery truck needs 22 feet of width and 60 feet of height clearance. If space is limited, consider a 20-yard dumpster (16' x 7') or discuss placement options with your rental company."
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12 bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <div className="w-full h-40 bg-gradient-to-br from-green-500 to-green-600 rounded-lg mb-4 flex items-center justify-center">
              ...
              <div className="text-center">
                <div className="w-full h-40 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg mb-4 flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              ...
              <a href="tel:801-918-6000" className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 px-6 rounded-lg hover:from-purple-600 hover:to-blue-500 transition-all duration-300 font-semibold text-center block">
                Get 15-Yard Quote
              </a>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200 transform scale-105">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-gradient-to-r from-green-500 to-blue-600 text-white px-4 py-1 rounded-full text-sm font-bold">
                  Most Popular
                </span>
              </div>
              <div className="text-center mb-6">
              ...
              <a href="tel:801-918-6000" className="w-full bg-gradient-to-r from-green-500 to-blue-600 text-white py-3 px-6 rounded-lg hover:from-blue-600 hover:to-green-500 transition-all duration-300 font-semibold text-center block">
                Get 20-Yard Quote
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <span className="bg-green-100 text-green-800 px-2 py-1 rounded text-sm font-semibold mr-3">20-30 Yard</span>
                  <span className="text-gray-600">Whole house renovation</span>
                </div>
                <div className="flex items-center">
                  <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-sm font-semibold mr-3">15-20 Yard</span>
                  <span className="text-gray-600">Kitchen/bathroom remodel</span>
                </div>
                <div className="flex items-center">
                  <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm font-semibold mr-3">15 Yard</span>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  <span className="bg-green-100 text-green-800 px-2 py-1 rounded text-sm font-semibold mr-3">30 Yard</span>
                  <span className="text-gray-600">New construction</span>
                </div>
                <div className="flex items-center">
                  <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-sm font-semibold mr-3">20-30 Yard</span>
                  <span className="text-gray-600">Addition/extension</span>
                </div>
                <div className="flex items-center">
                  <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-sm font-semibold mr-3">15-20 Yard</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  <a href="/dumpster-calculator" className="text-[#4e37a8] hover:text-purple-700 transition-colors">
                    Dumpster Calculator
                  </a>
                </h3>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 text-center hover:shadow-lg transition-shadow">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  <a href="/dumpster-sizes" className="text-[#4e37a8] hover:text-purple-700 transition-colors">
                    Dumpster Sizes
                  </a>
                </h3>
              </div>

...
export const metadata: Metadata = {
  "title": "Residential Dumpster Rental Kearns, UT | Residential Waste Solutions",
  "description": "residential dumpster rental services in Kearns, Utah. Reliable waste management for homeowners and residents. Get a free quote today.",
  "keywords": [
    "residential dumpster rental",
    "Kearns residential dumpster",
    "utah business dumpster rental",
    "waste management solutions"
  ],
  "alternates": {
    "canonical": "/services/residential-dumpster-rental-kearns-ut"
  },
  "openGraph": {
    "title": "Residential Dumpster Rental Kearns, UT | Residential Waste Solutions",
    "description": "residential dumpster rental services in Kearns, Utah. Reliable waste management for homeowners and residents.",
    "url": "https://icondumpsters.com/services/residential-dumpster-rental-kearns-ut",
    "images": [
      {
        "url": "/images/og-image.png",
        "width": 1200,
        "height": 630,
        "alt": "Kearns Residential Dumpster Rental - Icon Dumpsters"
      }
    ],
    "type": "website"
  },
...
export default function KearnsResidentialDumpsterRentalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        title={`Premier Residential Dumpster Rental in Kearns, UT`}
        subtitle={`At Icon Dumpsters, we provide Residential Dumpster Rental services designed for you – Kearns homeowners and residents who need reliable, convenient waste removal solutions for your projects.`}
      ...
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Residential Dumpster Services in Kearns</h2>
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-gray-800">Home Waste Management</h3>
            <p className="text-lg text-gray-600 mb-6">
              We provide convenient residential dumpster rental services throughout Kearns, 
          ...
          <div className="relative">
            <div className="relative w-full h-64 rounded-lg overflow-hidden">
              <Image
                ...
                alt="Kearns residential dumpster rental"
                fill
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Home Projects We Support in Kearns</h2>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Local Kearns Expertise</h3>
              <p className="text-lg text-gray-600 mb-6">
                We're your neighbors in Kearns and understand the unique needs of local 
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Tackle Your Kearns Home Project?</h2>

...
export const metadata: Metadata = {
  ...
  keywords: ['residential dumpster rental', 'home waste removal', 'house cleanout', 'renovation dumpster', `Magna residential dumpster`, 'utah home dumpster rental'],
  alternates: { canonical: `/services/residential-dumpster-rental-magna-ut` },
  openGraph: {
    title: `Residential Dumpster Rental Magna, UT | Home Waste Removal`,
    description: `Residential dumpster rental services in Magna, Utah. Home renovation, cleanout, and maintenance waste removal.`,
    url: `https://icondumpsters.com/services/residential-dumpster-rental-magna-ut`,
    images: [{ url: '/images/og-image.png', width: 1200, height: 630, alt: `Magna Residential Dumpster Rental - Icon Dumpsters` }],
    type: 'website'
  },
  robots: { index: true, follow: true }
};

export default function MagnaResidentialDumpsterRentalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        title={`Premier Residential Dumpster Rental in Magna, UT`}
        subtitle={`At Icon Dumpsters, we provide Residential Dumpster Rental services designed for you – Magna homeowners and residents who need reliable, convenient waste removal solutions for your projects.`}
      ...
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Residential Dumpster Services in Magna</h2>
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-gray-800">Home Waste Management</h3>
            <p className="text-lg text-gray-600 mb-6">
              We provide convenient residential dumpster rental services throughout Magna, 
          ...
          <div className="relative">
            <div className="relative w-full h-64 rounded-lg overflow-hidden">
              <Image
                ...
                alt="Magna residential dumpster rental"
                fill
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Home Projects We Support in Magna</h2>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Local Magna Expertise</h3>
              <p className="text-lg text-gray-600 mb-6">
                We're your neighbors in Magna and understand the unique needs of local 
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Tackle Your Magna Home Project?</h2>

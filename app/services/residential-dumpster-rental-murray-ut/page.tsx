...
export const metadata: Metadata = {
  "title": "Residential Dumpster Rental Murray, UT | Residential Waste Solutions",
  "description": "residential dumpster rental services in Murray, Utah. Reliable waste management for homeowners and residents. Get a free quote today.",
  "keywords": [
    "residential dumpster rental",
    "Murray residential dumpster",
    "utah business dumpster rental",
    "waste management solutions"
  ],
  "alternates": {
    "canonical": "/services/residential-dumpster-rental-murray-ut"
  },
  "openGraph": {
    "title": "Residential Dumpster Rental Murray, UT | Residential Waste Solutions",
    "description": "residential dumpster rental services in Murray, Utah. Reliable waste management for homeowners and residents.",
    "url": "https://icondumpsters.com/services/residential-dumpster-rental-murray-ut",
    "images": [
      {
        "url": "/images/og-image.png",
        "width": 1200,
        "height": 630,
        "alt": "Murray Residential Dumpster Rental - Icon Dumpsters"
      }
    ],
    "type": "website"
  },
...
export default function MurrayResidentialDumpsterRentalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        title={`Premier Residential Dumpster Rental in Murray, UT`}
        subtitle={`At Icon Dumpsters, we provide Residential Dumpster Rental services designed for you – Murray homeowners and residents who need reliable, convenient waste removal solutions for your projects.`}
      ...
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Residential Dumpster Services in Murray</h2>
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-gray-800">Home Waste Management</h3>
            <p className="text-lg text-gray-600 mb-6">
              We provide convenient residential dumpster rental services throughout Murray, 
          ...
          <div className="relative">
            <div className="relative w-full h-64 rounded-lg overflow-hidden">
              <OptimizedImage src="/images/optimized/dumpsterSmallBanner5.jpg"
                alt="Murray residential dumpster rental"
                fill
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Home Projects We Support in Murray</h2>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Local Murray Expertise</h3>
              <p className="text-lg text-gray-600 mb-6">
                We're your neighbors in Murray and understand the unique needs of local 
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Tackle Your Murray Home Project?</h2>

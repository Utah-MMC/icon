...
export const metadata: Metadata = {
  ...
  keywords: ['commercial dumpster rental', 'business waste management', 'construction dumpster', 'commercial waste removal', `Magna commercial dumpster`, 'utah business dumpster rental'],
  alternates: { canonical: `/services/commercial-dumpster-rental-magna-ut` },
  openGraph: {
    title: `Commercial Dumpster Rental Magna, UT | Business Waste Solutions`,
    description: `Commercial dumpster rental services in Magna, Utah. Reliable waste management for businesses and construction sites.`,
    url: `https://icondumpsters.com/services/commercial-dumpster-rental-magna-ut`,
    images: [{ url: '/images/og-image.png', width: 1200, height: 630, alt: `Magna Commercial Dumpster Rental - Icon Dumpsters` }],
    type: 'website'
  },
  robots: { index: true, follow: true }
};

export default function MagnaCommercialDumpsterRentalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        title={`Premier Commercial Dumpster Rental in Magna, UT`}
        subtitle={`At Icon Dumpsters, we provide Commercial Dumpster Rental services designed for you – businesses and business owners in Magna who need reliable, professional waste management solutions.`}
        primaryCtaText="Reserve Commercial Dumpster Now!"
        primaryCtaLink="/free-quote"
        secondaryCtaText={`Back to Magna`}
        secondaryCtaLink={`/cities/magna`}
        showCta={true}
      />

      {/* Commercial Services Overview */}
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Commercial Dumpster Services in Magna</h2>
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-gray-800">Business Waste Management</h3>
            <p className="text-lg text-gray-600 mb-6">
              We provide comprehensive commercial dumpster rental services throughout Magna, 
          ...
          <div className="relative">
            <div className="relative w-full h-64 rounded-lg overflow-hidden">
              <OptimizedImage src="/images/optimized/dumpsterSmallBanner5.jpg"
                alt="Magna commercial dumpster rental"
                fill
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Industries We Serve in Magna</h2>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Professional Magna Service</h3>
              <p className="text-lg text-gray-600 mb-6">
                We understand the unique needs of Magna businesses and provide 
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready for Professional Waste Management in Magna?</h2>

  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        ...
        subtitle="Professional waste management solutions for residential and commercial projects across Utah"
        backgroundImage="/images/dumpsters.jpeg"
        showOverlay={true}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <button
              ...
              className={`px-6 py-3 rounded-md font-medium transition-colors ${
                activeTab === 'residential'
                  ? 'bg-white text-[#4e37a8] shadow-sm'
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {service.sizes.map((size, sizeIndex) => (
                          <span
                            key={sizeIndex}
                            className="px-3 py-1 bg-[#4e37a8] text-white text-xs rounded-full"
                          >
                            {size}
                          </span>
                        ))}
        ...
        <div className="mt-20 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Get a free quote for your project. Our team will help you choose the right dumpster size and schedule delivery at your convenience.
          </p>

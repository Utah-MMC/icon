...
export const metadata: Metadata = {
  ...
  description: 'Professional downsizing dumpster rentals for moving projects, estate cleanouts, and life transitions. Residential-friendly service throughout Utah. Call (801) 918-6000.',
  alternates: { canonical: '/services/downsizing-dumpster-rentals' },
  ...
  return (
    <PageTemplate>
      <PageHero
        ...
        subtitle="Professional dumpster rentals for moving projects, estate cleanouts, and life transitions"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-12 text-white">
          <h2 className="text-3xl font-bold mb-4">Ready to Start Your Downsizing Journey?</h2>
          <p className="text-xl mb-8 opacity-90">
            Get a free quote for your downsizing dumpster rental today. Our team is ready to help you choose the perfect size and schedule convenient delivery for your life transition project.
          </p>

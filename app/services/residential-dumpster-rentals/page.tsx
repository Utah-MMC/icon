...
export const metadata: Metadata = {
  ...
  description: 'Residential-friendly dumpster rentals for home projects, renovations, and cleanouts. Professional delivery and pickup throughout Utah. Call (801) 918-6000 for quotes.',
  alternates: { canonical: '/services/residential-dumpster-rentals' },
  ...
  return (
    <PageTemplate>
      <PageHero
        ...
        subtitle="Professional, residential-friendly dumpster rentals for your home projects"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="bg-gradient-to-br from-[#4e37a8] to-purple-600 rounded-2xl p-8 text-white">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="w-12 h-12 bg-[#4e37a8] rounded-lg flex items-center justify-center mb-4">
        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#4e37a8] text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">1</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#4e37a8] text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">2</div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-[#4e37a8] text-white rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold">3</div>
        ...
        <div className="text-center bg-gradient-to-r from-[#4e37a8] to-purple-600 rounded-2xl p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Get a free quote for your residential dumpster rental today. Our team is ready to help you choose the perfect size and schedule convenient delivery.
          </p>

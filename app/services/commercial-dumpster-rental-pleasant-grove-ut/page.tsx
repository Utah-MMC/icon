...
export const metadata: Metadata = {
  "title": "Commercial Dumpster Rental Pleasant Grove, UT | Commercial Waste Solutions",
  "description": "commercial dumpster rental services in Pleasant Grove, Utah. Reliable waste management for businesses and construction sites. Get a free quote today.",
  "keywords": [
    "commercial dumpster rental",
    "Pleasant Grove commercial dumpster",
    "utah business dumpster rental",
    "waste management solutions"
  ],
  "alternates": {
    "canonical": "/services/commercial-dumpster-rental-pleasant-grove-ut"
  },
  "openGraph": {
    "title": "Commercial Dumpster Rental Pleasant Grove, UT | Commercial Waste Solutions",
    "description": "commercial dumpster rental services in Pleasant Grove, Utah. Reliable waste management for businesses and construction sites.",
    "url": "https://icondumpsters.com/services/commercial-dumpster-rental-pleasant-grove-ut",
    "images": [
      {
        "url": "/images/og-image.png",
        "width": 1200,
        "height": 630,
        "alt": "Pleasant Grove Commercial Dumpster Rental - Icon Dumpsters"
      }
    ],
    "type": "website"
  },
...
export default function PleasantGroveCommercialDumpsterRentalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        title={`Premier Commercial Dumpster Rental in Pleasant Grove, UT`}
        subtitle={`At Icon Dumpsters, we provide Commercial Dumpster Rental services designed for you – businesses and business owners in Pleasant Grove who need reliable, professional waste management solutions.`}
        primaryCtaText="Reserve Commercial Dumpster Now!"
        primaryCtaLink="/free-quote"
        secondaryCtaText={`Back to Pleasant Grove`}
        secondaryCtaLink={`/cities/pleasant-grove`}
        showCta={true}
      />

      {/* Commercial Services Overview */}
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Commercial Dumpster Services in Pleasant Grove</h2>
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-gray-800">Business Waste Management</h3>
            <p className="text-lg text-gray-600 mb-6">
              We provide comprehensive commercial dumpster rental services throughout Pleasant Grove, 
          ...
          <div className="relative">
            <div className="relative w-full h-64 rounded-lg overflow-hidden">
              <Image
                ...
                alt="Pleasant Grove commercial dumpster rental"
                fill
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Industries We Serve in Pleasant Grove</h2>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Professional Pleasant Grove Service</h3>
              <p className="text-lg text-gray-600 mb-6">
                We understand the unique needs of Pleasant Grove businesses and provide 
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready for Professional Waste Management in Pleasant Grove?</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link 
              href="/dumpster-rental-pleasant-grove-ut"
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors"
            >
              View All Pleasant Grove Services
            </Link>
          </div>
        </div>
      </div>

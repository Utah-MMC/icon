        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <header className="mb-12 text-center">
            <div className="flex items-center justify-center gap-4 mb-6 text-sm text-gray-600">
              <span className="bg-orange-600 text-white px-3 py-1 rounded-full text-xs font-semibold">ROOFING</span>
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              Use our roofing dumpster calculator to estimate the right dumpster size and costs for roofing waste disposal. 
              Calculate roofing material weight, volume, and rental costs for Utah projects with accurate pricing.
            </p>
          ...
          <section className="mb-16 bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg border border-gray-100">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Calculate the perfect dumpster size and cost for your roofing project. Enter your project details below.
              </p>
            </div>
            <DumpsterCalculator />
          </section>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              ...
              right dumpster size and understand the costs involved.
            </p>
            ...
            <h3>Dumpster Size Guidelines for Roofing Projects</h3>
            ...
            <div className="bg-green-50 p-6 rounded-lg my-6">
              <h4 className="text-lg font-semibold text-green-900 mb-3">Roof Area Calculation</h4>

...
export const metadata: Metadata = {
  title: "Taylorsville Dumpster Rental Services - Residential & Commercial | Icon Dumpsters",
  description: "Comprehensive dumpster rental services in Taylorsville, Utah. Residential, commercial, construction, and demolition services. Same-day delivery available. 15-30 yard roll-off dumpsters. Call (801) 918-6000.",
  keywords: "Taylorsville dumpster rental services, residential dumpster Taylorsville, commercial dumpster Taylorsville, construction dumpster Taylorsville, waste management Taylorsville, roll-off dumpster Taylorsville",
  openGraph: {
    title: "Taylorsville Dumpster Rental Services - Residential & Commercial | Icon Dumpsters",
    description: "Comprehensive dumpster rental services in Taylorsville, Utah. Residential, commercial, construction, and demolition services. Same-day delivery available.",
    url: 'https://icondumpsters.com/taylorsville-dumpster-rentals/services',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Taylorsville Dumpster Rental Services - Icon Dumpsters',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  alternates: {
    canonical: '/taylorsville-dumpster-rentals/services',
  },
  robots: {
    index: true,
    follow: true,
...
export default function TaylorsvilleServicesPage() {
  return (
    <PageTemplate>
      <PageHero
        title="Taylorsville Dumpster Rental Services"
        subtitle="Comprehensive waste management solutions for residential and commercial projects in Taylorsville, Utah"
        primaryCtaText="Get Free Quote"
        primaryCtaLink="/taylorsville-dumpster-rentals#quote-form"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Professional Dumpster Rental Services in Taylorsville, Utah
          </h2>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-6">
            At Icon Dumpsters, we provide comprehensive dumpster rental services throughout Taylorsville and surrounding areas. Our mission is to deliver hassle-free, professional waste management solutions for homeowners, contractors, and businesses alike.
          </p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="mb-6">
              <Image
                ...
                alt="Residential dumpster rental services in Taylorsville, Utah"
                width={600}
                height={300}
            ...
            <p className="text-lg text-gray-700 mb-6">
              Our residential dumpster rental services in Taylorsville are designed to handle all your home improvement and cleanup needs. From small renovation projects to major home overhauls, we provide the right dumpster size for your specific requirements.
            </p>
            ...
            <Link 
              href="/taylorsville-dumpster-rentals"
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="mb-6">
              <Image
                ...
                alt="Commercial dumpster rental services in Taylorsville, Utah"
                width={600}
                height={300}
                className="w-full h-48 object-cover rounded-lg"
              />
            ...
            <p className="text-lg text-gray-700 mb-6">
              Our commercial dumpster rental services in Taylorsville support businesses of all sizes with reliable waste management solutions. We understand the unique needs of commercial projects and provide flexible rental terms to accommodate your business operations.
            </p>
            <ul className="space-y-3 text-lg text-gray-700 mb-6">
        ...
        <section className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Available Dumpster Sizes for Taylorsville Projects</h2>
          <p className="text-lg text-gray-700 mb-8 text-center max-w-4xl mx-auto">
            Choose the perfect dumpster size for your Taylorsville project. All rentals include delivery, pickup, and landfill fees. Weight is billed at $55/ton after pickup.
          </p>
          
          <div className="mb-8">
            <Image
              src="/images/20-yard-roll-off-dumpster-rental-graphic-labeled.jpg"
              alt="Dumpster size comparison for Taylorsville projects"
              width={800}
              height={300}
        ...
        {/* Service Process */}
        <section className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Our Taylorsville Service Process</h2>
          <p className="text-lg text-gray-700 mb-8 text-center max-w-4xl mx-auto">
            Our streamlined process makes dumpster rental in Taylorsville simple and stress-free. From initial consultation to final pickup, we handle every detail professionally.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="bg-blue-50 p-6 rounded-lg text-center">
            ...
            <p className="text-gray-700 mb-4">Fast, reliable delivery throughout Taylorsville and surrounding areas. Order by 3 PM for next-day delivery.</p>
          ...
          <div className="bg-green-50 p-6 rounded-lg text-center">
            ...
            <p className="text-gray-700 mb-4">Transparent pricing with no hidden fees. Best rates in Taylorsville and the surrounding area.</p>
            <ul className="text-sm text-gray-600 space-y-1">
        ...
        {/* Local Information */}
        <section className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Serving Taylorsville and Surrounding Areas</h2>
          <p className="text-lg text-gray-700 mb-8 text-center max-w-4xl mx-auto">
            Icon Dumpsters proudly serves Taylorsville, Utah, and the surrounding communities. We understand the local area and can help you navigate any permit requirements or local regulations.
          </p>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-4">🏛️ Taylorsville Permit Information</h3>
              <p className="text-gray-700 mb-4">
                Taylorsville may require permits for dumpster placement on public streets or certain locations. Contact Taylorsville City at (801) 963-5400 to check specific requirements for your address.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4">
                We provide dumpster rental services throughout Taylorsville and surrounding areas including West Valley City, Kearns, and West Jordan.
              </p>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Taylorsville City limits</li>
        ...
        {/* FAQ Section */}
        <section className="bg-white rounded-xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Frequently Asked Questions - Taylorsville Dumpster Rental</h2>
          
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Do I need a permit for dumpster rental in Taylorsville?</h3>
              <p className="text-gray-700">
                Permit requirements vary by location in Taylorsville. Contact Taylorsville City at (801) 963-5400 to check specific requirements for your address. We can help guide you through the permit process and ensure compliance with local regulations.
              </p>
            </div>
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Do you offer same-day delivery in Taylorsville?</h3>
              <p className="text-gray-700">
                Yes, we offer same-day delivery throughout Taylorsville when available. Call us early in the day to check availability and schedule same-day service for urgent projects.
              </p>
            </div>
        ...
        {/* CTA Section */}
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Get Started with Your Taylorsville Project?</h2>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Get your Taylorsville dumpster rental quote today. Fast delivery, competitive pricing, and professional service you can trust.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link 
              href="/taylorsville-dumpster-rentals#quote-form"

...
export const metadata: Metadata = {
  title: "Dumpster Rentals in Utah County County, Utah | Icon Dumpsters",
  description: "Professional dumpster rental services throughout Utah County County, Utah. Same-day delivery, competitive pricing, and excellent customer service for all your waste management needs.",
  keywords: "dumpster rental Utah County County Utah, Utah County County dumpster rental, Utah dumpster rental, same day delivery",
  openGraph: {
    title: "Dumpster Rentals in Utah County County, Utah | Icon Dumpsters",
    description: "Professional dumpster rental services throughout Utah County County, Utah. Same-day delivery and competitive pricing.",
    url: 'https://icondumpsters.com/dumpster-rental-utah-county-ut',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Dumpster Rentals in Utah County County, Utah - Icon Dumpsters',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    title: "Dumpster Rentals in Utah County County, Utah | Icon Dumpsters",
    description: "Professional dumpster rental services throughout Utah County County, Utah.",
    images: ['/images/og-image.png'],
  },
  alternates: {
    canonical: '/dumpster-rental-utah-county-ut',
  },
  robots: {
    index: true,
    follow: true,
...
export default function UtahCountyCountyPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        title="Dumpster Rentals in Utah County County, Utah"
        subtitle="Professional dumpster rental services throughout Utah County County. Same-day delivery, competitive pricing, and excellent customer service for all your waste management needs."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Cities We Serve in Utah County County
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Professional dumpster rental services available in all cities throughout Utah County County.
            </p>
          </div>
      ...
      <section className="py-16 bg-[#4e37a8] text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-6">
            Ready to Get Started in Utah County County?
          </h2>
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Fill out the form below and we'll get back to you with a custom quote for your project in Utah County County.
            </p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="provo">Provo</option><option value="orem">Orem</option><option value="lehi">Lehi</option><option value="lindon">Lindon</option><option value="pleasant-grove">Pleasant Grove</option><option value="american-fork">American Fork</option><option value="eagle-mountain">Eagle Mountain</option><option value="saratoga-springs">Saratoga Springs</option><option value="cedar-hills">Cedar Hills</option><option value="highland">Highland</option><option value="alpine">Alpine</option><option value="mapleton">Mapleton</option><option value="spanish-fork">Spanish Fork</option><option value="springville">Springville</option><option value="payson">Payson</option><option value="santaquin">Santaquin</option><option value="genola">Genola</option><option value="woodland-hills">Woodland Hills</option><option value="vineyard">Vineyard</option>
              </select>
            </div>

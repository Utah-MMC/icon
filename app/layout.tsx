...
export const metadata: Metadata = {
  title: "Icon Dumpsters - Professional Dumpster Rental Services",
  description: "Professional dumpster rental services for construction, renovation, and waste management. Get reliable, affordable dumpster rentals from Icon Dumpsters.",
  icons: {
    icon: '/favicon.ico',
  },
};
            ...
            <div className="flex justify-between items-center text-sm">
              <div className="flex items-center space-x-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span>Call or Text Mon - Fri : 08.00 AM - 09.00 PM</span>
                </div>
              </div>
              <div className="flex items-center space-x-6">
                <div className="flex items-center space-x-2">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              <div className="flex items-center">
                                  <img src="/images/Icon_Dumpsters_Final.png" alt="Icon Dumpsters Logo" className="h-12 w-auto" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
              </div>
                  ...
                  <a href="#our-services" className="text-white hover:text-purple-200 transition-colors font-medium">SERVICES</a>
                  <a href="#" className="text-white hover:text-purple-200 transition-colors font-medium">RENTAL LOCATIONS</a>
                  <div className="relative group">
                    <a href="#" className="text-white hover:text-purple-200 transition-colors font-medium flex items-center">
                      DUMPSTER SIZES
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                    ...
                    <img src="/images/Icon_Dumpsters_Final.png" alt="Icon Dumpsters Logo" className="h-10 w-auto" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
                    <div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Dumpster Rental</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Waste Management</a></li>
                  <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Construction Cleanup</a></li>
            ...
            <div className="mt-8 pt-8 border-t border-gray-700">
              <p className="text-gray-400 text-sm text-center">
                © 2024 Icon Dumpsters. All rights reserved. | (555) 123-4567
              </p>
            </div>
          </div>
        </footer>

  ...
  return (
    <>
      ...
      <ArticleSchema
        ...
        description="Use our concrete debris calculator to estimate concrete waste volume, weight, and disposal costs. Calculate concrete debris for demolition and construction projects in Utah."
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <header className="mb-12 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Concrete Debris Calculator: Calculate Concrete Waste & Disposal Costs
            </h1>
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              Use our concrete debris calculator to estimate concrete waste volume, weight, and disposal costs. 
              Calculate concrete debris for demolition and construction projects in Utah with accurate pricing.
            </p>
          ...
          <section className="mb-16 bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg border border-gray-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Concrete Debris Calculator</h2>
              <p className="text-lg text-gray-600 mb-6">
                Calculate concrete debris volume, weight, and disposal costs for your project. Enter your project details below.
              </p>
            </div>
            <DumpsterCalculator />
          </section>
          ...
          <div className="prose prose-lg max-w-none">
            <h2>Understanding Concrete Debris Calculations</h2>
            <p>
              Concrete debris is one of the heaviest and most challenging materials to dispose of properly. Whether you're 
              removing a driveway, foundation, sidewalk, or other concrete structure, accurate calculations are essential 
              for proper planning and cost estimation.
            </p>

            <h3>How to Calculate Concrete Debris Volume</h3>
            <p>
              Calculating concrete debris volume requires understanding the dimensions and thickness of the concrete structure:
            </p>
            ...
            <h3>Dumpster Size Requirements for Concrete Debris</h3>
            <p>
            ...
            <div className="bg-green-50 p-6 rounded-lg my-6">
              <h4 className="text-lg font-semibold text-green-900 mb-3">Calculation Process</h4>
              <ol className="text-green-800 space-y-2">
                ...
                <li><strong>Choose Dumpster Size:</strong> Based on weight capacity</li>
              </ol>
            </div>
            ...
            <ul>
              ...
              <li><strong>Location:</strong> Distance from disposal facilities affects pricing</li>
            ...
            <ul>
              ...
              <li><strong>Accurate Pricing:</strong> Transparent pricing with no hidden fees</li>

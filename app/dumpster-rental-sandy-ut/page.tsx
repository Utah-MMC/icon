...
export const metadata: Metadata = {
  title: 'Dumpster Rental Sandy, UT | Same‑Day Delivery | Icon Dumpsters',
  description: 'Sandy dumpster rental with same‑day delivery. 15‑30 yard roll‑off dumpsters, transparent pricing, and fast service. Get a free quote today.',
  keywords: ['dumpster rental', 'dumpster rental near me', 'utah dumpster rental', 'dumpster rental Utah', 'Sandy dumpster'],
  alternates: { canonical: '/dumpster-rental-sandy-ut' },
  openGraph: {
    title: 'Dumpster Rental Sandy, UT | Same‑Day Delivery | Icon Dumpsters',
    description: 'Sandy dumpster rental with same‑day delivery. 15‑30 yard roll‑off dumpsters, transparent pricing, and fast service.',
    ...
    <div className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-br from-[#4e37a8] via-purple-700 to-[#4e37a8] text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-6 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">Dumpster Rental Sandy, UT</h1>
            ...
            <div className="h-48 md:h-56 lg:h-64 relative rounded-xl overflow-hidden shadow-lg bg-white flex items-center justify-center">
              <ImageWithFallback src="/images/IMG_0350.jpg" fallbackSrc="/images/dumpsterWithTruck.jpeg" alt="Sandy dumpster rental" fill className="object-contain" />
            </div>
          </div>
        </div>
      </section>
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="bg-gradient-to-r from-[#4e37a8] to-purple-700 rounded-2xl p-8 text-white text-center mb-10">
          <h2 className="text-3xl font-bold mb-2">Ready to Get Your Dumpster in Sandy?</h2>

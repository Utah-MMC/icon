...
export default function BookClient() {
  ...
  if (step === 'check-availability') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#4e37a8] via-purple-700 to-[#4e37a8] relative overflow-hidden">
        {/* Background Image with Overlay */}
        <div className="absolute inset-0 bg-cover bg-center" style={{
          backgroundImage: 'url(/images/Icon_Dumpsters_Final.png)',
          backgroundSize: 'cover',
          backgroundPosition: 'center'
        }}>
          <div className="absolute inset-0 bg-[#4e37a8] bg-opacity-90"></div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white border-opacity-20">
                ...
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-gray-50 rounded-xl">
                    <div className="w-10 h-10 bg-[#4e37a8] rounded-full flex items-center justify-center mr-4">
                    ...
                    <div>
                      ...
                      <a href="tel:(801) 918-6000" className="text-lg font-bold text-[#4e37a8] hover:text-purple-700 transition-colors">
                        (801) 918-6000
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-4 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@icondumpsters.com" className="text-lg font-bold text-[#4e37a8] hover:text-purple-700 transition-colors">
                ...
                <div className="mt-6 p-4 bg-[#4e37a8] bg-opacity-10 rounded-xl border border-[#4e37a8] border-opacity-20">
                  <div className="flex items-center text-[#4e37a8]">
              ...
              <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white border-opacity-20">
                <div className="text-center mb-8">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#4e37a8] to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <form onSubmit={(e) => { e.preventDefault(); checkAvailability(); }} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#4e37a8] focus:border-transparent focus:bg-white transition-all duration-200"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-[#4e37a8] to-purple-600 hover:from-purple-600 hover:to-[#4e37a8] text-white py-4 px-6 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg hover:shadow-xl flex items-center justify-center space-x-3"
                  >
              ...
              <div className="inline-block bg-white bg-opacity-95 backdrop-blur-sm rounded-2xl p-6 shadow-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a 
                    ...
                    className="inline-flex items-center justify-center bg-[#4e37a8] text-white px-6 py-3 rounded-xl font-semibold hover:bg-purple-700 transition-colors shadow-lg hover:shadow-xl"
                  >
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>

...
export const metadata: Metadata = {
  ...
  description: 'Professional dumpster rental services in Park City, UT. Fast delivery, competitive pricing, and reliable waste management solutions. Call 801-918-6000 for instant quotes.',
  keywords: 'Park City dumpster rental, dumpster rental Park City UT, Park City UT dumpster, roll-off dumpster Park City, construction dumpster Park City, waste management Park City',
  openGraph: {
    title: 'Park City Dumpster Rental - Professional Dumpster Services in Park City, UT | (801-918-6000)',
    description: 'Professional dumpster rental services in Park City, UT. Fast delivery, competitive pricing, and reliable waste management solutions.',
...
export default function ParkCityDumpsterRental() {
    ...
    landmarks: [
  {
    ...
    "url": "https://www.park-city.utah.gov/"
  },
  {
    "name": "Park City Park",
    "address": "Local Park Address",
    "url": "https://www.google.com/maps/search/Park City%20Park"
  }
],
    businessDistricts: [
  {

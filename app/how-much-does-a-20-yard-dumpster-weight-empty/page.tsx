      ...
      <FAQSchema
        ...
        faqs={[
          ...
          },
          {
            ...
            answer: "A 20-yard dumpster is typically 22 feet long, 8 feet wide, and 4.5 feet high. These dimensions can vary slightly by manufacturer. The dumpster provides approximately 540 cubic feet of space and can hold up to 4 tons of material."
          }
        ]}
      />
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-green-50 p-6 rounded-lg my-6">
              <h4 className="text-lg font-semibold text-green-900 mb-3">Capacity Breakdown</h4>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h5 className="font-semibold text-green-800 mb-2">Volume Capacity (20 cubic yards)</h5>
                ...
                <div>
                  <h5 className="font-semibold text-green-800 mb-2">Weight Capacity (4 tons)</h5>
                  <ul className="text-green-700 space-y-1 text-sm">
                    <li>• 8,000 pounds</li>
            ...
            <ul>
              ...
              <li><strong>Competitive Pricing:</strong> Fair rates with no hidden weight charges</li>

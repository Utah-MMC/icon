...
export const metadata: Metadata = {
  title: 'Dumpster Sizes Guide | Choose the Right Size for Your Project | Icon Dumpsters',
  description: 'Complete guide to dumpster sizes and capacity. Learn which dumpster size is right for your project - from 10 yard to 40 yard options. Call (801) 918-6000 for expert advice!',

...
export const metadata: Metadata = {
  ...
  description: "Professional commercial dumpster rentals for office renovations, retail cleanouts, restaurant projects, and industrial waste removal. Same-day delivery and competitive pricing throughout Utah.",
  ...
  openGraph: {
    ...
    url: 'https://icondumpsters.com/dumpster-rental/business',
  ...
  alternates: {
    canonical: '/dumpster-rental/business',
  },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        ...
        subtitle="Professional waste management solutions for businesses of all sizes. Reliable service, flexible scheduling, and competitive rates."
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="bg-green-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-green-900 mb-3">Why Choose Us for Business Projects?</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <div className="text-2xl font-bold text-green-600">$549</div>

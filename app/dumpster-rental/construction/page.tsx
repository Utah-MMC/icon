...
export const metadata: Metadata = {
  ...
  description: "Heavy-duty construction dumpster rentals for new construction, demolition, roofing, and large-scale renovation projects. Multiple sizes available with same-day delivery throughout Utah.",
  ...
  openGraph: {
    title: "Construction Dumpster Rentals for Building Projects | Icon Dumpsters",
    description: "Heavy-duty construction dumpster rentals for new construction, demolition, roofing, and large-scale renovation projects.",
    url: 'https://icondumpsters.com/dumpster-rental/construction',
  ...
  alternates: {
    canonical: '/dumpster-rental/construction',
  },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        ...
        subtitle="Heavy-duty dumpster solutions for construction and demolition projects. Built to handle the toughest job site waste."
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-orange-500 pl-4">
                  ...
                  <div className="text-2xl font-bold text-orange-600">$349</div>
                ...
                <div className="border-l-4 border-orange-500 pl-4">
                  ...
                  <div className="text-2xl font-bold text-orange-600">$449</div>
                ...
                <div className="border-l-4 border-orange-500 pl-4">
                  ...
                  <div className="text-2xl font-bold text-orange-600">$549</div>

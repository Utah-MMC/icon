...
export const metadata: Metadata = {
  ...
  description: "Professional residential dumpster rentals for home renovations, cleanouts, and yard projects. Same-day delivery, competitive pricing, and excellent customer service throughout Utah.",
  ...
  openGraph: {
    title: "Residential Dumpster Rentals for Home Projects | Icon Dumpsters",
    description: "Professional residential dumpster rentals for home renovations, cleanouts, and yard projects. Same-day delivery and competitive pricing throughout Utah.",
    url: 'https://icondumpsters.com/dumpster-rental/home',
  ...
  alternates: {
    canonical: '/dumpster-rental/home',
  },
  robots: {
    index: true,
    follow: true,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <PageHero
        ...
        subtitle="Professional dumpster rental services for all your home projects. From renovations to cleanouts, we've got you covered."
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <div className="text-2xl font-bold text-blue-600">$449</div>

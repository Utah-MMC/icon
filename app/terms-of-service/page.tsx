...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for Icon Dumpsters. Learn about our rental agreements, service terms, and customer responsibilities.",
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
              <p className="text-blue-800 font-semibold mb-2">Important Rental Terms</p>
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6">
              ...
              <ul className="list-disc pl-6 text-yellow-700 text-sm">
                ...
                <li>Early pickup requests: Pro-rated refund for unused days</li>
                <li>Weather-related cancellations: Full refund or rescheduling</li>
              </ul>
            </div>

            <h2 className="text-2xl font-bold text-gray-900 mb-6">10. Safety and Compliance</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-6">11. Communication and Notifications</h2>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              For complete details about our privacy practices, please review our <a href="https://icondumpsters.com/privacy-policy" className="text-blue-600 underline">Privacy Policy</a>.
            </p>
            ...
            <div className="mt-8 p-4 bg-blue-50 border-l-4 border-blue-400">
              <p className="text-blue-800 text-sm">
                ...
                Please also review our <a href="https://icondumpsters.com/privacy-policy" className="text-blue-600 underline">Privacy Policy</a> for information about how we handle your data.
              </p>

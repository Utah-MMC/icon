...
export const metadata: Metadata = {
  ...
  keywords: "Herriman dumpster rental services, residential dumpster Herriman, commercial dumpster Herriman, construction dumpster Herriman",
  openGraph: {
    title: "Herriman Dumpster Rental Services - Residential & Commercial | Icon Dumpsters",
    description: "Comprehensive dumpster rental services in Herriman, Utah. Residential, commercial, construction, and demolition services.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Herriman Dumpster Rental Services
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Comprehensive dumpster rental services in Herriman, Utah. Residential, commercial, construction, and demolition services.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                href="https://icondumpsters.com/herriman-dumpster-rentals#quote-form" 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <Link 
              href="https://icondumpsters.com/herriman-dumpster-rentals"
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-blue-50 p-6 rounded-lg text-center">
            ...
            <p className="text-gray-700">Fast, reliable delivery throughout Herriman and surrounding areas.</p>
          </div>
          <div className="bg-green-50 p-6 rounded-lg text-center">
            <h3 className="text-xl font-semibold text-green-900 mb-4">💰 Competitive Pricing</h3>
            <p className="text-gray-700">Transparent pricing with no hidden fees. Best rates in Herriman.</p>
          </div>
        ...
        <div className="mt-12 text-center">
          ...
          >
            ← Back to Herriman Dumpster Rentals
          </Link>
        </div>
      </div>
    </div>

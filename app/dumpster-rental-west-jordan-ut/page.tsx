...
export const metadata: Metadata = {
  title: 'Dumpster Rental West Jordan, UT | Fast Delivery & Competitive Pricing',
  description: 'Dumpster rental in West Jordan, Utah. Multiple sizes available with same-day delivery. Get competitive pricing and professional service from Icon Dumpsters.',
  keywords: ['dumpster rental West Jordan', 'West Jordan dumpster', 'utah dumpster rental', 'construction waste removal'],
  alternates: { canonical: '/dumpster-rental-west-jordan-ut' },
  openGraph: {
    title: 'Dumpster Rental West Jordan, UT | Fast Delivery & Competitive Pricing',
    description: 'Dumpster rental in West Jordan, Utah. Multiple sizes available with same-day delivery. Get competitive pricing and professional service.',
...
export default function WestJordanDumpsterRentalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <PageHero
        title={`Dumpster Rental in West Jordan, UT`}
        subtitle={`Fast, reliable dumpster delivery for all your West Jordan projects`}
      ...
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Dumpster Sizes Available in West Jordan</h2>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Why Choose Icon Dumpsters in West Jordan?</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Local West Jordan Service</h3>
              <p className="text-lg text-gray-600 mb-6">
                We're your local West Jordan dumpster rental experts. Our team knows the area, 
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <span className="text-blue-600 mr-3">📞</span>
                  <span>Local West Jordan phone: (801) 918-6000</span>
                </div>
                <div className="flex items-center">
                  <span className="text-blue-600 mr-3">📍</span>
                  <span>Serving all West Jordan neighborhoods</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative w-full h-64 rounded-lg overflow-hidden">
              <OptimizedImage src="/images/optimized/dumpsterSmallBanner5.jpg"
                alt="West Jordan dumpster rental service areas"
                fill
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">West Jordan Service Areas</h3>
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready for Your West Jordan Project?</h2>

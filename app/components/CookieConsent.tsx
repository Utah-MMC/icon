        ...
        <div className="bg-white border border-gray-200 shadow-xl rounded-xl overflow-hidden">
          <div className="p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div className="flex items-center justify-between rounded-lg border border-gray-200 p-3">
                ...
                <label className="inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:bg-[#4e37a8] transition-colors"></div>
                </label>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:justify-end">
              ...
              <button onClick={savePreferences} className="w-full sm:w-auto px-4 py-2 rounded-lg border border-[#4e37a8] text-[#4e37a8] hover:bg-purple-50">
                Save Preferences
              </button>
              <button onClick={acceptAll} className="w-full sm:w-auto px-4 py-2 rounded-lg bg-[#4e37a8] text-white hover:bg-purple-700">
                Accept All
              </button>
            </div>
          </div>

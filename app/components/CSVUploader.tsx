      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#4e37a8] file:text-white hover:file:bg-purple-700"
          />
        </div>
        ...
        <button
          ...
          disabled={isUploading}
          className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4e37a8] disabled:opacity-50"
        >
          Load Sample Data
        </button>
        ...
        {isUploading && (
          <div className="flex items-center justify-center py-4">
            <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-[#4e37a8]"></div>

    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className={`relative bg-white rounded-lg shadow-xl max-w-md w-full mx-4 transform transition-all duration-300 ${isVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
        <div className="p-8 text-center">
          ...
          {/* Phone icon */}
          <div className="w-16 h-16 bg-[#4e37a8] rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <a 
              ...
              className="text-3xl font-bold text-[#4e37a8] hover:text-purple-700 transition-colors"
            >
              (801) 918-6000
            </a>
          </div>
          ...
          <a 
            href="tel:(801) 918-6000"
            className="w-full bg-[#4e37a8] text-white py-3 px-6 rounded-lg hover:bg-purple-700 transition-colors font-medium text-lg inline-block"
          >
            CALL NOW
          </a>

        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#4e37a8]"
              ...
              <button
                type="submit"
                className="w-full bg-[#4e37a8] text-white py-3 rounded-lg hover:bg-purple-700 transition-colors font-medium"
              >
                Get My Quote
              </button>
            </form>
            ...
            <p className="text-sm text-gray-500 mt-4 text-center">
              Or call us directly: <a href="tel:(801) 918-6000" className="text-[#4e37a8] font-medium">(801) 918-6000</a>
            </p>
          </div>
        </div>
      )}

...
export const metadata: Metadata = {
  ...
  keywords: ['dumpster rental Ogden', 'Ogden dumpster', 'utah dumpster rental', 'construction waste removal'],
  alternates: { canonical: '/dumpster-rental-ogden-ut' },
  openGraph: {
    title: 'Dumpster Rental Ogden, UT | Fast Delivery & Competitive Pricing',
    description: 'Dumpster rental in Ogden, Utah. Multiple sizes available with same-day delivery. Get competitive pricing and professional service.',
    url: 'https://icondumpsters.com/dumpster-rental-ogden-ut',
    images: [{ url: '/images/og-image.png', width: 1200, height: 630, alt: 'Ogden Dumpster Rental - Icon Dumpsters' }],
    type: 'website'
  },
  robots: { index: true, follow: true }
};

export default function OgdenDumpsterRentalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section using PageHero component */}
      <PageHero
        title={`Dumpster Rental in Ogden, UT`}
        subtitle={`Fast, reliable dumpster delivery for all your Ogden projects`}
      ...
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Dumpster Sizes Available in Ogden</h2>
      ...
      <div className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Why Choose Icon Dumpsters in Ogden?</h2>
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Local Ogden Service</h3>
              <p className="text-lg text-gray-600 mb-6">
                We're your local Ogden dumpster rental experts. Our team knows the area, 
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <span className="text-blue-600 mr-3">📞</span>
                  <span>Local Ogden phone: (801) 918-6000</span>
                </div>
                <div className="flex items-center">
                  <span className="text-blue-600 mr-3">📍</span>
                  <span>Serving all Ogden neighborhoods</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative w-full h-64 rounded-lg overflow-hidden">
              <OptimizedImage src="/images/optimized/dumpsterSmallBanner5.jpg"
                alt="Ogden dumpster rental service areas"
                fill
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <h3 className="text-2xl font-bold mb-4 text-gray-800">Ogden Service Areas</h3>
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready for Your Ogden Project?</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link 
              href="https://icondumpsters.com/ogden-dumpster-rental-guide-2025"
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors"
            >
              Read Our Ogden Guide
            </Link>
          </div>
        </div>
      </div>

        ...
        faqs={[
          {
            ...
            answer: "Dumpster volume is calculated by multiplying length × width × height. For example, a 20-yard dumpster is typically 22' × 8' × 4.5' = 792 cubic feet, which equals approximately 20 cubic yards. Our dumpster volume calculator can help you determine the exact volume you need."
          },
          {
            question: "What are the dimensions of different dumpster sizes?",
            answer: "15-yard dumpsters are typically 16' × 8' × 4.5', 20-yard dumpsters are 22' × 8' × 4.5', and 30-yard dumpsters are 22' × 8' × 6'. These dimensions can vary slightly by manufacturer. Use our calculator to find the exact dimensions for your project."
          },
          {
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <header className="mb-12 text-center">
            <div className="flex items-center justify-center gap-4 mb-6 text-sm text-gray-600">
              <span className="bg-blue-600 text-white px-3 py-1 rounded-full text-xs font-semibold">CALCULATOR</span>
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
              Use our dumpster volume calculator to determine the right dumpster size for your project. 
          ...
          <section className="mb-16 bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg border border-gray-100">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Calculate the perfect dumpster size and volume for your project. Enter your project details below.
              </p>
            </div>
            <DumpsterCalculator />
          </section>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              Choosing the right dumpster size for your project requires understanding volume calculations and capacity limits. 
            ...
            <div className="overflow-x-auto my-6">
              <table className="min-w-full bg-white border border-gray-300 rounded-lg">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-900">Dumpster Size</th>
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-sm text-gray-700">22' × 8' × 6'</td>
            ...
            <div className="bg-green-50 p-6 rounded-lg my-6">
              <h4 className="text-lg font-semibold text-green-900 mb-3">Step-by-Step Volume Calculation</h4>
            ...
            <ol>
              ...
              <li><strong>Compare options:</strong> See different dumpster sizes and their costs</li>
            ...
            <ul>
              ...
              <li><strong>Flexible Options:</strong> Multiple dumpster sizes to meet your needs</li>
              <li><strong>Cost Transparency:</strong> Clear pricing with no hidden fees</li>
            ...
            <Link href="/demolition-dumpster-calculator" className="group">
              <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">Use our demolition dumpster calculator to estimate the right dumpster size, weight capacity, and rental costs for your demolition project.</p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/dumpster-calculator-for-concrete" className="group">
              <div className="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">Use our concrete dumpster calculator to estimate the right dumpster size and costs for concrete disposal and demolition projects.</p>
                </div>
              </div>
            </Link>
          </div>

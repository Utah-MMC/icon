...
export const metadata: Metadata = {
  title: 'How to Choose the Right Dumpster Size | Utah Dumpster Rental Guide',
  description: 'Learn how to pick the right dumpster size for your project. Compare 15, 20, and 30 yard roll‑off dumpsters, typical uses, and weight tips. Get a free quote today.',
  keywords: ['dumpster rental', 'dumpster rental near me', 'utah dumpster rental', 'dumpster sizes', 'roll‑off dumpster'],
  alternates: { canonical: '/blog/how-to-choose-dumpster-size' },
  openGraph: {
    title: 'How to Choose the Right Dumpster Size | Utah Dumpster Rental Guide',
    description: 'Compare sizes, uses, and weight tips to choose the best dumpster for your project.',
    url: 'https://icondumpsters.com/blog/how-to-choose-dumpster-size',
    images: [{ url: '/images/og-image.png', width: 1200, height: 630, alt: 'Dumpster Sizes Guide - Icon Dumpsters' }],
    type: 'article'
  },

...
export const metadata: Metadata = {
  title: 'Dumpster Rental Lindon | Fast Delivery & Affordable Rates',
  description: 'Get reliable dumpster rental in Lindon, UT. Same-day delivery, competitive pricing, and professional service. 10-40 yard dumpsters available. Call (801) 555-0123 for instant quote!',
  keywords: 'dumpster rental lindon, lindon dumpster rental, roll-off dumpster lindon, construction dumpster lindon, waste disposal lindon',
  openGraph: {
    title: 'Dumpster Rental Lindon | Fast Delivery & Affordable Rates',
    description: 'Professional dumpster rental services in Lindon, UT. Same-day delivery, competitive pricing, and reliable waste disposal solutions.',
    type: 'website',
    url: 'https://icondumpsters.com/lindon',
  },
};

export default function LindonDumpsterRental() {
  return (
      ...
      <article className="max-w-4xl mx-auto px-4 py-8">
        <header className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Dumpster Rental Lindon
          </h1>
          <p className="text-lg text-gray-600 mb-4">
            Professional dumpster rental services in Lindon, Utah. Get same-day delivery, competitive pricing, and reliable waste disposal solutions for your next project.
          </p>
          <div className="flex items-center text-sm text-gray-500">
            <span>Service Area: Lindon, UT</span>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Lindon & Surrounding Areas</p>
            </div>
            <div className="text-center">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Choose Lindon Dumpster Rental?</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Local Expertise</h3>
              <p className="text-gray-600">We know Lindon and understand local regulations, permit requirements, and best practices for waste disposal in the area.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Popular Projects in Lindon</h2>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg p-8 text-white text-center">
            ...
            <p className="text-lg mb-6">Get instant pricing and same-day delivery for your Lindon project.</p>
        ...
        <section className="mb-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <p className="text-gray-600 mb-4">
              For detailed information about dumpster sizes, pricing, permits, and best practices in Lindon, 
              check out our comprehensive guide:
            </p>
            <a 
              href="/lindon-dumpster-rental-guide-2025" 
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Service Areas Near Lindon</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-2">📍 Lindon, UT</p>
